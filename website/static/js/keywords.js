...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '解决篇': {class: 'bg-black text-white text-sm px-1 me-1 rounded-lg', tooltip: '我方「案件」为解决篇时生效'},
        '案件篇': {class: 'bg-black text-white text-sm px-1 me-1 rounded-lg', tooltip: '我方「案件」为案件篇时生效'},
        '宣言': {class: 'bg-blue-500 text-white text-sm px-1 me-1 rounded-lg', tooltip: '宣言使用能力，通过支付费用就能处理效果'},
        ...
        '绊: (.*?)': {class: 'text-sm px-1 me-1 rounded-lg', label: '<span class="bg-black text-white px-1 rounded-l-lg" style="box-shadow: 0 0 0 1px black;">绊</span><b class="bg-white font-bold text-black px-1 box-shadow-1 rounded-r-lg">$2</b>', tooltip: '我方「现场」中存在卡名为[$2]的角色时使用'},
        ...
        '回合1': {class: 'bg-cyan-400 text-white text-sm px-1 me-1 rounded-lg', label: '回合<span class="card-color card-color-radius bg-white ring-1" style="color: #22d3ee; width: 1rem; height: 1rem;">1</span>', tooltip: '每回合只能发动1次'},
        '回合2': {class: 'bg-cyan-400 text-white text-sm px-1 me-1 rounded-lg', label: '回合<span class="card-color text-cyan-400 card-color-radius bg-white" style="color: #22d3ee">2</span>', tooltip: '每回合最多发动2次'},
