...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '(案件: )([一-龥a-zA-Z0-9_]+) 或 ([一-龥a-zA-Z0-9_]+)': {class: 'bg-pink-600 text-white text-sm p-0\.5 me-1 rounded-lg', label: '$2 <span class="card-color card-color--$3 card-color-radius">$3</span>或<span class="card-color card-color--$4 card-color-radius">$4</span>', tooltip: '此能力只能在我方案件的颜色拥有$3色或$4色时使用'},
