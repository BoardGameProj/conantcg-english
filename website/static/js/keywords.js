...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '(搭档: )([一-龥a-zA-Z0-9_]+)': {class: 'bg-pink-600 text-white text-sm px-1 me-1 rounded-lg', label: '$2 <span class="card-color card-color--$3 card-color-radius bg-white">$3</span>', tooltip: '此能力只能在我方搭档颜色是$3色时使用'},
        ...
        '绊: (.*?)': {class: 'text-sm px-1 me-1 rounded-lg', label: '<span class="bg-black text-white px-1 rounded-l-lg">绊</span><span class="bg-white text-black px-1 rounded-r-lg">$2</span>', tooltip: '此能力只能在我方现场存在卡名为“$2”的角色时使用'},
        '档案: (\\d+)': {class: 'text-sm px-1 me-1 rounded-lg', label: '<span class="bg-red-700 text-white p-0.5 rounded-lg">档案 $2</span>', tooltip: '此能力只能在我方档案区至少有$2张牌时使用'},
        '回合①': {class: 'bg-cyan-400 text-white text-sm px-1 me-1 rounded-lg', tooltip: '此能力每回合只能使用1次'},
        '回合②': {class: 'bg-cyan-400 text-white text-sm px-1 me-1 rounded-lg', tooltip: '此能力每回合只能使用2次'},
