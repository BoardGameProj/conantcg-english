...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '(案件)(YAIBA|浪漫洗牌|红魔法|犯人)': { class: 'bg-pink-600 text-white text-xs px-1 me-1 rounded', label: '<b>案件</b>$3', tooltip: '<button class="search-form-btn" data-target-key="type" data-value="案件" data-target-key-1="categories" data-value-1="$3">我方案件特征有[$3]时生效</button>' },
