...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '(案件)(YAIBA|浪漫洗牌|红魔法|犯人|相亲大会)': { class: 'bg-pink-600 text-white text-xs px-1 me-1 rounded', label: '<b>案件</b>$3', tooltip: '<button class="search-form-btn" data-target-key="type" data-value="案件" data-target-key-1="categories" data-value-1="$3">我方案件特征有[$3]时生效</button>' },
        ...
        '回合3': { class: 'bg-cyan-400 text-white text-xs pl-1 me-1 rounded-lg', label: '回合<span class="text-xs card-color card-color-radius bg-white text-cyan-400 ring-1 ring-cyan-400">3</span>', tooltip: '每回合最多发动3次' },
        ...
        '疾风': { class: 'font-normal bg-blue-500 text-white text-xs px-1 me-1 rounded', tooltip: '本回合中首个于我方现场登场时发动' },
        ...
        '介入': { class: 'dark:text-white text-xs me-1', label: '<img src="img/cut_in.svg" class="inline-icon-small"><b>$1</b>', tooltip: '接触时从手牌移除以使用' },
        '变装': { class: 'dark:text-white text-xs me-1', label: '<img src="img/disguise.svg" class="inline-icon-small"><b>$1</b>', tooltip: '从手牌中打出替换接触中的角色。将被替换的角色移入卡组底' },
        '灵光一闪': { class: 'dark:text-white text-xs me-1', label: '<img src="img/hirameki.svg" class="inline-icon-small"><b>$1</b>', tooltip: '作为证据被移除时发动' },
    ...
    const highlightKeywords = {
        ...
        '{突击}［等级(\\d+)以(下|上)角色］': { tag: 'b', tooltip: '登场回合可以立刻以等级$2以$3的角色为对象进行行动' },
        '{突击}': { tag: 'b', tooltip: '登场回合可以立刻进行行动' },
        '{痕迹}': { tag: 'b', tooltip: '本场游戏中对手进行过刷新' },
