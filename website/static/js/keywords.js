...
function processKeywords(text) {
    ...
    const keywords = {
        ...
        '解决篇': {class: 'bg-black text-white text-sm px-1 me-1 rounded-lg', tooltip: '我方案件为解决篇时，可使用此效果或能力'},
        '案件篇': {class: 'bg-black text-white text-sm px-1 me-1 rounded-lg', tooltip: '我方案件为案件篇时，可使用此效果或能力'},
